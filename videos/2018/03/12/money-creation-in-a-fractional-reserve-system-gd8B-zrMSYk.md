...
[![Thumbnail](https://i.ytimg.com/vi/gd8B-zrMSYk/hqdefault.jpg?sqp=-oaymwEcCNACELwBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLD9o_PIdwitj4V_7JHt03qAXkLlFw)](https://www.youtube.com/watch?v=gd8B-zrMSYk)

| | |
|---|---|
| **Channel** | [Khan Academy](../../../../README.md) |
| **Published** | 2018-03-12T18:02:10-07:00 |
| **Duration** | 8:09 |
| **Views** | 220.7K |
| **Likes** | 3.4K |
| **YouTube** | [Watch](https://www.youtube.com/watch?v=gd8B-zrMSYk) |
...
`education` `online learning` `learning` `lessons` `economics and finance` `ap macroeconomics` `macroeconomics` `money and banking` `fractional reserve banking` `money multiplier` `M1` `money supply` 
